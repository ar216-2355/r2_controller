...
//         );
//         // 10msループ
//         timer_ = this->create_wall_timer(10ms, std::bind(&R2ControllerNode::timer_callback, this));
//     }
...
//             case 1: {
//                 bool finish = ele_ctrl_.elevator_percent(0.5, current_motors_[MotorId::ELEVATOR-1].angle, msg);
...
//             case 2: {
//                 bool finish1 = arm_ctrl_.left_arm_angle(-10, current_motors_[MotorId::ARM_LF-1].angle, current_motors_[MotorId::ARM_LB-1].angle, msg);
//                 bool finish2 = arm_ctrl_.right_arm_angle(-85, current_motors_[MotorId::ARM_RB-1].angle, current_motors_[MotorId::ARM_RF-1].angle, msg);
//                 if (finish1 && finish2) {
//                     state_ = 3;
